...
I think technical leadership as an individual contributor is a mix of deep technical research, project management, and /diplomacy/ 🤝

In order for a software project to be successful, it has to /actually work/ and be delivered /on time/. The intersection between these success criteria is all about /shared understanding/, which is where the diplomacy comes in.
...
For me these three stages are:

1. Research
2. Propose
3. Negotiate

The first two stages are where the technical work happens. However, it's the third stage--negotiation--which is the most critical. This is where people build a common understanding of their shared goals, and where misconceptions and disagreements are resolved 💡

I've written more about these three stages in a blog post here: https://akuszyk.com/2025-11-06-three-stages-of-technical-leadership.html

If you've experienced these stages in a different form, or have other ways of framing them, I'd love to hear from you! 💬
...
#+begin_src plantuml :file 2025-11-06-three-stages-of-technical-leadership.org-research-propose-negotiate.png
!theme crt-green
storage "📚 Research" as res
storage "📣 Propose" as prop
storage "🤝 Negotiate" as neg
storage "🤞 Propose" as prop2
storage "🙏 Negotiate" as neg2
storage "😅 Propose" as prop3
storage "🙏🙏 Negotiate" as neg3
...
#+RESULTS:
[[file:2025-11-06-three-stages-of-technical-leadership.org-research-propose-negotiate.png]]
...
#+begin_src plantuml :file 2025-11-06-three-stages-of-technical-leadership.org-research.png
!theme crt-green
storage "📚 Research" as res
label " " as prop
...
#+RESULTS:
[[file:2025-11-06-three-stages-of-technical-leadership.org-research.png]]
...
#+begin_src plantuml :file 2025-11-06-three-stages-of-technical-leadership.org-proposal.png

!theme crt-green
storage "📚 Research" as res
storage "📣 Propose" as prop
label " " as neg
collections "💡 Problems" as prob
...
#+RESULTS:
[[file:2025-11-06-three-stages-of-technical-leadership.org-proposal.png]]
...
The /proposal/ stage is where you summarise your research, state your problem, and propose the path you think should be followed. Writing good technical proposals is a [[https://akuszyk.com/2025-04-11-how-i-write-technical-documents.html][challenge in itself]], but take care not to get too attached to your proposal when it's finished.
...
#+begin_src plantuml :file 2025-11-06-three-stages-of-technical-leadership.org-problem-statements.png
!theme crt-green

usecase "Problem 1" as p1
usecase "Problem 2" as p2
usecase "Problem 3" as p3

file "Proposal" as prop1
file "Proposal" as prop2
file "Proposal" as prop3
file "Proposal" as prop4
file "Proposal" as prop5
file "Proposal" as prop6
...
#+RESULTS:
[[file:2025-11-06-three-stages-of-technical-leadership.org-problem-statements.png]]
** Stage 3: Negotiate
...
#+begin_src plantuml :file 2025-11-06-three-stages-of-technical-leadership.org-negotiate.png

!theme crt-green
storage "📚 Research" as res
storage "📣 Propose" as prop
storage "🤝 Negotiate" as neg
label "The most important step!" as imp
...
#+RESULTS:
[[file:2025-11-06-three-stages-of-technical-leadership.org-negotiate.png]]
...
#+begin_src plantuml :file 2025-11-06-three-stages-of-technical-leadership.org-more-proposals.png
!theme crt-green
storage "📚 Research" as res
storage "📣 Propose" as prop
storage "🤝 Negotiate" as neg
...
#+RESULTS:
[[file:2025-11-06-three-stages-of-technical-leadership.org-more-proposals.png]]
