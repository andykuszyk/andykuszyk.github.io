...
There are many aspects to good platform-building (e.g. testing, secrets management, monitoring & alerting, etc.), but one of the most fundamental is observability.

I've written a blog post that takes a tour through the observability landscape covering logging, metrics, and tracing. I've included examples of how you might set youself up for success from day one with the likes of @prometheus @grafana @datadog and @newrelic:

https://akuszyk.com/2026-03-12-getting-observability-right.html

If you're one a journey of building the foundations of a new platform, or reflecting on an established one, I hope this post proves interesting!
...
#+begin_src plantuml :file 2026-03-12-getting-observability-right.org-metrics-aggregator.png :noweb yes
<<plantuml-theme>>
node "Machine 1" as n1 {
  rectangle "your-program" as p1
  rectangle "your-program" as p2
  rectangle "Metrics\ncollector" as m1
  p1 --> m1 : Publish
...
#+RESULTS:
[[file:2026-03-12-getting-observability-right.org-metrics-aggregator.png]]
...
#+begin_src plantuml :file 2026-03-12-getting-observability-right.org-metrics-chart-example.png
<<plantuml-theme>>
@startchart
<style>
chartDiagram {
...
h-axis "Time" [10:00, 11:00, 12:00, 13:00, 14:00, 15:00]
v-axis "Count of HTTP status codes" 0 --> 100 spacing 20
line "200" [45, 62, 58, 70, 83, 78] #lightgreen
line "500" [5, 7, 3, 4, 2, 8] #red
legend bottom
@endchart
...
#+RESULTS:
[[file:2026-03-12-getting-observability-right.org-metrics-chart-example.png]]

*** DONE Traces
CLOSED: [2026-03-12 Thu 11:41]
