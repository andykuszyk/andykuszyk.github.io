...
If it does have a go.mod file, then it is not compliant if the go.mod file contains github.com/aws/aws-sdk-go but not github.com/aws/aws-sdk-go-v2. If the go.mod file contains github.com/aws/aws-sdk-go-v2 but not github.com/aws/aws-sdk-go-v2, then it is fully compliant.
...
Whereas previously I would think /"that's a good idea, maybe I'll do it some day"/, now I just ask Claude Code to do it in the background. It costs me a couple of minutes to write the prompt, and more often than not it gets the job down. Now, the limit to my productivity is less my available time, and more my available ideas.
** What?
